...
1. Desrosières A (1990) How to Make Things Which Hold Together : Social Science, Statistics and the State in *Discourses On Society*. Dordrecht: Kluwer Academic Publishers.
2. Bowker GC and Star SL (1999). “The Case of Race Classification and Reclassification under Apartheid” in *Sorting Things Out: Classification and Its Consequences*. Cambridge Mass: MIT Press.
3. Porter TM (1995). “How social numbers are made valid” in *Trust in Numbers*. The Pursuit of Objectivity in Science and Public Life. Princeton: University Press.
...
* **In preparation for the class**, read and prepare to discuss one of the following texts:
1. D’Ignazio C and Klein LF (2020) “What Gets Counted Counts” in *Data Feminism*. Cambridge Mass .: MIT Press.
2. Boullier D (2017) Big data challenges for the social sciences: from society and opinion to replications. *ISA eSymposium for Sociology* July.
...
* **In preparation for the class**, read and prepare to discuss one of the following texts:
1. Gerlitz C and Helmond A (2013) The like economy: Social buttons and the data-intensive web. New Media & Society 15 (8).
2. Venturini T (2019) “From Fake to Junk News, the Data Politics of Online Virality”. In: Bigo D, Isin E, and Ruppert E (eds) Data Politics: Worlds, Subjects, Rights. London: Routledge, pp. 123–144.
3. Bach D, Tsapatsaris MR, Szpirt M, et al. (2020) The Baker’s Guild: The Secret Order Countering 4chan’s Affordances. [oilab.eu/the-bakers-guild-the-secret-order-countering-4chans-affordances/](https://oilab.eu/the-bakers-guild-the-secret-order-countering-4chans-affordances/).
...
* **In preparation for the class**, read and prepare to discuss one of the following texts:
1. Gitelman L (2013). “Dataveillance and Countervailance” in *“Raw Data” Is an Oxymoron*. Cambridge Mass .: MIT Press.
2. Gabrys J, Pritchard H and Barratt B (2016). Just good enough data: Figuring data citizenships through air pollution sensing and data stories. *Big Data & Society* 3 (2).
3. Gray J, Lämmerhirt D and Bounegru L (2016). Changing what counts. *DataShift*: 52. 
...
1. Rogers R (2017). “Foundations of Digital Methods: Query Design” in Schaefer M and van Es K (eds) The Datafied Society. Amsterdam: University Press, pp. 75–94.
...
* **In preparation for the class**, read:
1. Dumit J and Nafus D (2018). “The other ninety per cent: Thinking with data science, creating data studies” in *Ethnography for a Data-Saturated World*, pp. 252–274.
...
* **In preparation for the class**, read:
1. Behrens JT and Chong-Ho Y (2003) Exploratory Data Analysis. In: Weiner IB (ed.) *Handbook of Psychology*. London: Wiley.
...
* **In preparation for the class**, read
1. Tufte ER (1983) “Data-Ink Maximization and Graphical Design” in *The Visual Display of Quantitative Information*. Cheshire: Graphics Press.
2. Drucker J (2011) Humanities Approaches to Graphical Display. DHQ: *Digital Humanities Quarterly*, 5 (1): 1–20.
...
* **In preparation for the class**, read:
1. Venturini T, Jacomy M and Jensen P (2020) What do we See when We Look at Networks. An Introduction to Visual Network Analysis and Force-Directed Layouts. *Big Data & Society* (fothcoming).
...
* **In preparation for the class**, read:
1. Costa C (2020) “A Tour of Machine Learning Algorithms Read this introductory list of machine learning algorithms” in *Toward Data Science* [towardsdatascience.com/a-tour-of-machine-learning-algorithms-466b8bf75c0a](http://towardsdatascience.com/a-tour-of-machine-learning-algorithms-466b8bf75c0a)
2. Cielen D, Meysman ADB and Ali M (2016) “Machine Learning” in *Introducing Data Science*: pp. 57–84.
...
1. Read: Venturini T, Bounegru L, Gray J, et al. (2018) A reality check (list) for digital methods. *New Media & Society*, 20 (11).
...
* **In preparation for the class**, read
1. Segel E and Heer J (2010) Narrative visualization: telling stories with data. *IEEE Transactions on Visualization and Computer Graphics*, 16 (6).
...
* **In preparation for the class**, read:
1. Bruno I, Didier E and Vitale T (2014) Statactivism: forms of action between disclosure and affirmation. *The Open Journal of Sociopolitical Studies*, 2 (7): 198–220.
